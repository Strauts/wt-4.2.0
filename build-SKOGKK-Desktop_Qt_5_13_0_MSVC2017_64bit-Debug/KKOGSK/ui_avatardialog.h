...
public:
    ...
    void retranslateUi(QDialog *avatarDialog)
    {
        ...
        groupBox->setTitle(QCoreApplication::translate("avatarDialog", "GroupBox", nullptr));
        ...
        pushButton->setText(QCoreApplication::translate("avatarDialog", "G\303\245 tilbake", nullptr));
    } // retranslateUi
